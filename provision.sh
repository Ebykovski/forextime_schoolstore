...
tools_go() {
	# Install basic tools
	apt-get -y install build-essential binutils-doc git subversion mc
}
...
php_go() {
	apt-get -y install php5 php5-curl php5-mysql php5-sqlite php5-xdebug php5-gd  php5-imagick
	#php5-pear
